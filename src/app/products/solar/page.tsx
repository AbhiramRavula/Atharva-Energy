...
export const metadata: Metadata = {
  title: "Solar Panels",
  description:
    "Atharva Energy's high-efficiency monocrystalline solar panels for industrial and commercial applications. Manufactured in Hyderabad, India.",
};

export default function SolarPage() {
  const product = products.find((p) => p.slug === "solar");
